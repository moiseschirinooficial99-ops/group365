  ...
  return (
    <main className="bg-[#0F1419] min-h-screen">
      <div className="max-w-3xl mx-auto px-6 py-20 text-gray-300">
        ...
        <p className="mb-4">GRUPO 360 INICIATIVAS S.L. · NIF B13911979 · Passeig de Les Palmeres 16, Reus, Tarragona · info@group360.es</p>
        ...
        <p className="mb-4">Puedes solicitar acceso, rectificación, eliminación, limitación u oposición al tratamiento de tus datos escribiendo a <span className="text-[#C9A84C]">info@group360.es</span></p>
