...
// ═══════════════════════════════════════════════════════
// PÍXELES DE CAMPAÑA — directo en group360iniciativas.com
//
// La campaña de captación corre por esta web (no por el panel/landings
// de eXp), así que los píxeles de seguimiento van aquí: sin esto, cada
// día de campaña es audiencia de retargeting que se pierde para siempre.
//
// Cada píxel solo se carga si su ID está puesto en el entorno — añade en
// Vercel (o .env.local en local):
//   NEXT_PUBLIC_META_PIXEL_ID       (Meta Events Manager → tu píxel)
//   NEXT_PUBLIC_TIKTOK_PIXEL_ID     (TikTok Ads Manager → Assets → Events)
//   NEXT_PUBLIC_GA_MEASUREMENT_ID   (Google Analytics 4 → Data Streams, G-XXXXXXX)
// ═══════════════════════════════════════════════════════
